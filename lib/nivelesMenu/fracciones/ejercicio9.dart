...
class _Ejercicio9State extends State<Ejercicio9> {
  ...
  final int _denominadorCorrecto3=12; // Corregido según lógica común (12 es mcm de 3 y 4)
  final int _numeradorCorrecto4=17; // Corregido: 8+9=17

  // NOTA: Los valores correctos originales eran confusos (denominador 17?). 
  // 2/3 + 1/2 * 3/2 = 2/3 + 3/4 = 8/12 + 9/12 = 17/12.
  // Ajusté los valores correctos para que coincidan con la lógica matemática del ejercicio visual.
  // _denominadorCorrecto2 = 12
  // _numeradorCorrecto2 (2/3 a /12) = 8
  // _numeradorCorrecto3 (3/4 a /12) = 9
  // Resultado = 17/12
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  TextButton(
                    onPressed: () {
                      final numRespuesta1 = int.tryParse(_numeradorController1.text);
                      final denRespuesta1 = int.tryParse(_denominadorController1.text);
                      final numRespuesta2 = int.tryParse(_numeradorController2.text);
                      final denRespuesta2 = int.tryParse(_denominadorController2.text);
                      final numRespuesta3 = int.tryParse(_numeradorController3.text);
                      final denRespuesta3 = int.tryParse(_denominadorController3.text);
                      final numRespuesta4 = int.tryParse(_numeradorController4.text);
                      ...
                      numRespuesta1 == null ||
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(
                            content: Text('Por favor, completa la fracción con números válidos.'),
