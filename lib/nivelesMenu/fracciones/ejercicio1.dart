...
import 'package:mathgo/nivelSuperado/nivelSuperadoFracciones.dart';
...
class _Ejercicio1State extends State<Ejercicio1> {
  ...
  final String _numeradorCorrecto = '3';
  final String _denominadorCorrecto = '4';
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        Column(
                          children: [
                            Text('1 + 2', style: TextStyle(fontSize: 30, fontWeight: FontWeight.bold)),
