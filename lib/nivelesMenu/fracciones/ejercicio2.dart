...
class _Ejercicio2State extends State<Ejercicio2> {
  ...
  final String _numeradorCorrecto = '4';
  final String _denominadorCorrecto = '6';

  Future<void> _marcarCompletado() async {
    final prefs = await SharedPreferences.getInstance();
    await prefs.setBool('fraccion2', true);
  }
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        Column(
                          children: [
                            Text('5 - 1', style: TextStyle(fontSize: 30, fontWeight: FontWeight.bold)),
