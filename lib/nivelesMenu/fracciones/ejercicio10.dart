...
class _Ejercicio10State extends State<Ejercicio10> {
  ...
  final int _numeradorCorrecto1 = 5;
  final int _denominadorCorrecto1 =6;
  final int _numeradorCorrecto2 = 2;
  final int _denominadorCorrecto2 = 6;
  final int _numeradorCorrecto3=7;
  final int _denominadorCorrecto3=12;
  final int _numeradorCorrecto4=30;

  Future<void> _marcarCompletado() async {
    final prefs = await SharedPreferences.getInstance();
    await prefs.setBool('fraccion10', true);
  }
