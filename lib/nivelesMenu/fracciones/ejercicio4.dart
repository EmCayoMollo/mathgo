...
class _Ejercicio4State extends State<Ejercicio4> {
  ...
  final String _numeradorCorrecto = '12';
  final String _denominadorCorrecto = '14';

  Future<void> _marcarCompletado() async {
    final prefs = await SharedPreferences.getInstance();
    await prefs.setBool('fraccion4', true);
  }
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        Column(
                          children: [
                            Text('4 × 3', style: TextStyle(fontSize: 30, fontWeight: FontWeight.bold)),
                            SizedBox(width: 80, child:   Divider(color: Colors.black, thickness: 2)),
                            Text('7 × 2', style: TextStyle(fontSize: 30, fontWeight: FontWeight.bold)),
                          ],
                        ),
                        Padding(
                          padding: EdgeInsets.symmetric(horizontal: 16.0),
