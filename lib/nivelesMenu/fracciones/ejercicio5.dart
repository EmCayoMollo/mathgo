...
class _Ejercicio5State extends State<Ejercicio5> {
  ...
  final String _numeradorCorrecto1 = '9';
  ...
  Future<void> _marcarCompletado() async {
    ...
    await prefs.setBool('fraccion5', true);
  }
          ...
          child: Column(
            ...
            children: [
              ...
              TextButton(
                ...
                if (numRespuesta1.isEmpty || denRespuesta1.isEmpty || numRespuesta2.isEmpty || denRespuesta2.isEmpty) {
                ...
                if (numRespuesta1 == _numeradorCorrecto1 && denRespuesta1 == _denominadorCorrecto1 && numRespuesta2 == _numeradorCorrecto2 && denRespuesta2 == _denominadorCorrecto2) {
                  _marcarCompletado();
                  Navigator.push(
                    context,
